...
// Sbox maps the inputted byte through Rijndael's forward s-box.
func Sbox(in byte) byte {
	return sbox[in]
}

// sbox is an array that represents Rijndael's forward s-box.
var sbox = [256]byte{
...
// InvSbox maps the inputted byte through Rijndael's inverse s-box.
func InvSbox(in byte) byte {
	return invSbox[in]
}

// invSbox is an array that represents Rijndael's inverse s-box.
...
// rcon array of Rijndael finite field powers of two, starting with -1.
var rcon = [256]byte{
